...
- (void)viewDidLoad {
    ...
    CGFloat width = 80;
    [self.romate BtnType:CL_RoundviewTypeCustom BtnWith:width adjustFontSizesTowith:YES masksToBounds:YES corenrRadius:width/2 image:imageArray TitleArray:titleArray titleColor:[UIColor blackColor]];
